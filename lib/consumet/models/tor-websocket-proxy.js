...
class TorWebSocketProxy {
  constructor(torWebSocketUrl = process.env.TOR_WEBSOCKET_URL || 'wss://homeless-cosette-kayceeko-3490cd6d.koyeb.app/ws') {
    this.wsUrl = torWebSocketUrl;
    this.restUrl = process.env.TOR_REST_URL || 'https://homeless-cosette-kayceeko-3490cd6d.koyeb.app/api/proxy';
    this.ws = null;
